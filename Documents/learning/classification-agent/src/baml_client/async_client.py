...
class BamlAsyncClient:
    ...
    async def ClassifyPayloadItems(self, payload: typing.List["types.PayloadItemInput"],policy_context: str,
        baml_options: BamlCallOptions = {},
    ) -> types.ClassificationResult:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ClassifyPayloadItems(payload=payload,policy_context=policy_context,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ClassifyPayloadItems", args={
                "payload": payload,"policy_context": policy_context,
            })
...
class BamlStreamClient:
    ...
    def ClassifyPayloadItems(self, payload: typing.List["types.PayloadItemInput"],policy_context: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ClassificationResult, types.ClassificationResult]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ClassifyPayloadItems", args={
            "payload": payload,"policy_context": policy_context,
        })
...
class BamlHttpRequestClient:
    ...
    async def ClassifyPayloadItems(self, payload: typing.List["types.PayloadItemInput"],policy_context: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ClassifyPayloadItems", args={
            "payload": payload,"policy_context": policy_context,
        }, mode="request")
        return __result__
